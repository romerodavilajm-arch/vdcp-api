...
/**
 * Cuerpo de la petición para crear o actualizar un punto de venta. Comparte la estructura de PuntoDeVentaBase; se mantiene como schema independiente para permitir su extensión futura sin alterar el schema de respuesta. 
 */

@Schema(name = "PuntoDeVentaInput", description = "Cuerpo de la petición para crear o actualizar un punto de venta. Comparte la estructura de PuntoDeVentaBase; se mantiene como schema independiente para permitir su extensión futura sin alterar el schema de respuesta. ")
...
public class PuntoDeVentaInput implements Serializable {
   ...
   */
  public PuntoDeVentaInput(String nombre, TipoInstalacion tipoInstalacion, Estatus estatus, Integer coloniaId, Delegacion delegacion, Integer afiliacionId) {
    this.nombre = nombre;
  ...
  public PuntoDeVentaInput nombre(String nombre) {
    this.nombre = nombre;
    return this;
  }
  ...
  */
  ...
  public PuntoDeVentaInput tipoInstalacion(TipoInstalacion tipoInstalacion) {
    this.tipoInstalacion = tipoInstalacion;
    return this;
  }
  ...
  */
  ...
  public PuntoDeVentaInput estatus(Estatus estatus) {
    this.estatus = estatus;
    return this;
  }
  ...
  */
  ...
  public PuntoDeVentaInput delimitaciones(String delimitaciones) {
  ...
  */
  ...
  public PuntoDeVentaInput coloniaId(Integer coloniaId) {
    this.coloniaId = coloniaId;
    return this;
  }
  ...
  */
  ...
  public PuntoDeVentaInput referencia(String referencia) {
  ...
  */
  ...
  public PuntoDeVentaInput delegacion(Delegacion delegacion) {
    this.delegacion = delegacion;
    return this;
  }
  ...
  */
  ...
  public PuntoDeVentaInput poligono(String poligono) {
  ...
  */
  ...
  public PuntoDeVentaInput imagenUrl(URI imagenUrl) {
  ...
  */
  ...
  public PuntoDeVentaInput diasOperacion(List<DiaSemana> diasOperacion) {
    this.diasOperacion = JsonNullable.of(diasOperacion);
    return this;
  }

  public PuntoDeVentaInput addDiasOperacionItem(DiaSemana diasOperacionItem) {
  ...
  */
  ...
  public PuntoDeVentaInput horario(String horario) {
  ...
  */
  ...
  public PuntoDeVentaInput tipoHorario(TipoHorario tipoHorario) {
  ...
  */
  ...
  public PuntoDeVentaInput asociacion(String asociacion) {
  ...
  */
  ...
  public PuntoDeVentaInput afiliacionId(Integer afiliacionId) {
    this.afiliacionId = afiliacionId;
    return this;
  }
  ...
  */
  ...
  public PuntoDeVentaInput representanteGeneral(String representanteGeneral) {
  ...
  */
  ...
  public PuntoDeVentaInput estructura(String estructura) {
  ...
  */
  ...
  public PuntoDeVentaInput observaciones(String observaciones) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    PuntoDeVentaInput puntoDeVentaInput = (PuntoDeVentaInput) o;
    return Objects.equals(this.nombre, puntoDeVentaInput.nombre) &&
        Objects.equals(this.tipoInstalacion, puntoDeVentaInput.tipoInstalacion) &&
        Objects.equals(this.estatus, puntoDeVentaInput.estatus) &&
        equalsNullable(this.delimitaciones, puntoDeVentaInput.delimitaciones) &&
        Objects.equals(this.coloniaId, puntoDeVentaInput.coloniaId) &&
        equalsNullable(this.referencia, puntoDeVentaInput.referencia) &&
        Objects.equals(this.delegacion, puntoDeVentaInput.delegacion) &&
        equalsNullable(this.poligono, puntoDeVentaInput.poligono) &&
        equalsNullable(this.imagenUrl, puntoDeVentaInput.imagenUrl) &&
        equalsNullable(this.diasOperacion, puntoDeVentaInput.diasOperacion) &&
        equalsNullable(this.horario, puntoDeVentaInput.horario) &&
        equalsNullable(this.tipoHorario, puntoDeVentaInput.tipoHorario) &&
        equalsNullable(this.asociacion, puntoDeVentaInput.asociacion) &&
        Objects.equals(this.afiliacionId, puntoDeVentaInput.afiliacionId) &&
        equalsNullable(this.representanteGeneral, puntoDeVentaInput.representanteGeneral) &&
        equalsNullable(this.estructura, puntoDeVentaInput.estructura) &&
        equalsNullable(this.observaciones, puntoDeVentaInput.observaciones);
  }
  ...
  public String toString() {
    ...
    sb.append("class PuntoDeVentaInput {\n");
