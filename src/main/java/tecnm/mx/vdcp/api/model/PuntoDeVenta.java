...
/**
 * Punto de venta registrado en el padrón, incluyendo el identificador generado por el sistema.
 */

@Schema(name = "PuntoDeVenta", description = "Punto de venta registrado en el padrón, incluyendo el identificador generado por el sistema.")
...
public class PuntoDeVenta implements Serializable {
   ...
   */
  public PuntoDeVenta(String nombre, TipoInstalacion tipoInstalacion, Estatus estatus, Integer coloniaId, Delegacion delegacion, Integer afiliacionId, Integer id) {
    this.nombre = nombre;
  ...
  */
  ...
  public PuntoDeVenta tipoInstalacion(TipoInstalacion tipoInstalacion) {
    this.tipoInstalacion = tipoInstalacion;
    return this;
  }
  ...
  */
  ...
  public PuntoDeVenta estatus(Estatus estatus) {
    this.estatus = estatus;
    return this;
  }
  ...
  */
  ...
  public PuntoDeVenta delimitaciones(String delimitaciones) {
  ...
  */
  ...
  public PuntoDeVenta coloniaId(Integer coloniaId) {
    this.coloniaId = coloniaId;
    return this;
  }
  ...
  */
  ...
  public PuntoDeVenta referencia(String referencia) {
  ...
  */
  ...
  public PuntoDeVenta delegacion(Delegacion delegacion) {
    this.delegacion = delegacion;
    return this;
  }
  ...
  */
  ...
  public PuntoDeVenta poligono(String poligono) {
  ...
  */
  ...
  public PuntoDeVenta imagenUrl(URI imagenUrl) {
  ...
  */
  ...
  public PuntoDeVenta diasOperacion(List<DiaSemana> diasOperacion) {
    this.diasOperacion = JsonNullable.of(diasOperacion);
    return this;
  }

  public PuntoDeVenta addDiasOperacionItem(DiaSemana diasOperacionItem) {
  ...
  */
  ...
  public PuntoDeVenta horario(String horario) {
  ...
  */
  ...
  public PuntoDeVenta tipoHorario(TipoHorario tipoHorario) {
  ...
  */
  ...
  public PuntoDeVenta asociacion(String asociacion) {
  ...
  */
  ...
  public PuntoDeVenta afiliacionId(Integer afiliacionId) {
    this.afiliacionId = afiliacionId;
    return this;
  }
  ...
  */
  ...
  public PuntoDeVenta representanteGeneral(String representanteGeneral) {
  ...
  */
  ...
  public PuntoDeVenta estructura(String estructura) {
  ...
  */
  ...
  public PuntoDeVenta observaciones(String observaciones) {
  ...
  */
  ...
  public PuntoDeVenta id(Integer id) {
    this.id = id;
    return this;
  }

  /**
   * Identificador único del punto de venta, generado automáticamente.
   * minimum: 1
   * @return id
  */
  @Min(1) 
  @Schema(name = "id", accessMode = Schema.AccessMode.READ_ONLY, example = "1", description = "Identificador único del punto de venta, generado automáticamente.", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("id")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.nombre, puntoDeVenta.nombre) &&
        Objects.equals(this.tipoInstalacion, puntoDeVenta.tipoInstalacion) &&
        Objects.equals(this.estatus, puntoDeVenta.estatus) &&
        equalsNullable(this.delimitaciones, puntoDeVenta.delimitaciones) &&
        Objects.equals(this.coloniaId, puntoDeVenta.coloniaId) &&
        equalsNullable(this.referencia, puntoDeVenta.referencia) &&
        Objects.equals(this.delegacion, puntoDeVenta.delegacion) &&
        equalsNullable(this.poligono, puntoDeVenta.poligono) &&
        equalsNullable(this.imagenUrl, puntoDeVenta.imagenUrl) &&
        equalsNullable(this.diasOperacion, puntoDeVenta.diasOperacion) &&
        equalsNullable(this.horario, puntoDeVenta.horario) &&
        equalsNullable(this.tipoHorario, puntoDeVenta.tipoHorario) &&
        equalsNullable(this.asociacion, puntoDeVenta.asociacion) &&
        Objects.equals(this.afiliacionId, puntoDeVenta.afiliacionId) &&
        equalsNullable(this.representanteGeneral, puntoDeVenta.representanteGeneral) &&
        equalsNullable(this.estructura, puntoDeVenta.estructura) &&
        equalsNullable(this.observaciones, puntoDeVenta.observaciones) &&
        Objects.equals(this.id, puntoDeVenta.id);
  }
